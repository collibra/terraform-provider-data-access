...
page_title: "collibra-access-governance_grant Resource - collibra_access_governance"
subcategory: ""
description: |-
  The resource for representing a Collibra Access Governance Grant https://docs.raito.io/docs/cloud/access_management/grants access control.
---

# collibra-access-governance_grant (Resource)
...
- `what_data_objects` (Attributes Set) The data object what items associated to the grant. When this is not set (nil), the what list will not be overridden. This is typically used when this should be managed from Collibra Access Governance. (see [below for nested schema](#nestedatt--what_data_objects))
...
- `who` (Attributes Set) The who-items associated with the grant. When this is not set (nil), the who-list will not be overridden. This is typically used when this should be managed from Collibra Access Governance. (see [below for nested schema](#nestedatt--who))
