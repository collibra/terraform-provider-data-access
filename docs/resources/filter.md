...
page_title: "collibra-access-governance_filter Resource - collibra-access-governance"
subcategory: ""
description: |-
...
- `access_control` (String) The ID of the access control in Raito Cloud. Cannot be set if `user` is set.
