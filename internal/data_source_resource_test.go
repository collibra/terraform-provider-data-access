...
`, testId),
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("collibra-access-governance_datasource.test", "sync_method", string(dataAccessType.DataSourceSyncMethodOnprem)),
...
`, testId, dataAccessType.DataSourceSyncMethodCloudmanualtrigger),
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("collibra-access-governance_datasource.test", "sync_method", string(dataAccessType.DataSourceSyncMethodCloudmanualtrigger)),
					),
				},
