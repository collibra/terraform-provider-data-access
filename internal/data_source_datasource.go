	...
	response.Schema = schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"type": schema.StringAttribute{
				...
				Computed:            true,
				Sensitive:           false,
				Description:         "The type of the data source (for example, Snowflake or BigQuery).",
				MarkdownDescription: "The type of the data source (for example, Snowflake or BigQuery).",
			},
			...
			"edge_site_id": schema.StringAttribute{
				...
				Computed:            true,
				Sensitive:           false,
				Description:         "The ID of the Edge site of the data source.",
				MarkdownDescription: "The ID of the Edge site of the data source.",
			},
			"edge_connection_id": schema.StringAttribute{
				...
				Computed:            true,
				Sensitive:           false,
				Description:         "The ID of the Edge connection of the data source.",
				MarkdownDescription: "The ID of the Edge connection of the data source.",
			},
		},
		Description:         "The resource for representing a data source in Collibra Data Access.",
		MarkdownDescription: "The resource for representing a data source in Collibra Data Access.",
	}
}
