	...
	resp.Schema = schema.Schema{
		Attributes: map[string]schema.Attribute{
			"url": schema.StringAttribute{
				...
				Optional:            false,
				Sensitive:           false,
				Description:         "The base URL of your Collibra environment (for example, https://example.collibra.com)",
				MarkdownDescription: "The base URL of your Collibra environment (for example, https://example.collibra.com)",
			},
			"user": schema.StringAttribute{
				Required:            true,
				Optional:            false,
				Sensitive:           false,
				Description:         "The username to sign in to your Collibra environment.",
				MarkdownDescription: "The username to sign in to your Collibra environment.",
			},
			"secret": schema.StringAttribute{
				Required:            true,
				Optional:            false,
				Sensitive:           true,
				Description:         "The password to sign in to your Collibra environment.",
				MarkdownDescription: "The password to sign in to your Collibra environment.",
			},
		},
	}
}
