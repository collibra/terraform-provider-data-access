...
`,
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttrPair("collibra-data-access_grant.abac_grant", "data_source.0.data_source", "data.collibra-data-access_datasource.ds", "id"),
...
`,
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckNoResourceAttr("collibra-data-access_grant.abac_grant", "what_data_objects"),
						resource.TestCheckResourceAttr("collibra-data-access_grant.abac_grant", "what_abac_rule.rule", "{\"literal\":true}"),
						resource.TestCheckResourceAttr("collibra-data-access_grant.abac_grant", "what_abac_rule.scope.#", "2"),
						resource.TestCheckResourceAttr("collibra-data-access_grant.abac_grant", "what_abac_rule.global_permissions.#", "1"),
						resource.TestCheckResourceAttr("collibra-data-access_grant.abac_grant", "what_abac_rule.global_permissions.0", "WRITE"),
						resource.TestCheckResourceAttr("collibra-data-access_grant.abac_grant", "what_abac_rule.permissions.#", "1"),
						resource.TestCheckResourceAttr("collibra-data-access_grant.abac_grant", "what_abac_rule.permissions.0", "SELECT"),
						resource.TestCheckResourceAttr("collibra-data-access_grant.abac_grant", "what_abac_rule.do_types.#", "2"),
						resource.TestCheckResourceAttr("collibra-data-access_grant.abac_grant", "who.#", "1"),
						resource.TestCheckResourceAttr("collibra-data-access_grant.abac_grant", "who.0.user", "terraform-acc-test-1@collibra.com"),
						resource.TestCheckResourceAttr("collibra-data-access_grant.abac_grant", "who_locked", "true"),
